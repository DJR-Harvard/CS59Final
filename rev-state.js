...
rl.question('Enter the year for which you want to find revenue by state: ', async (inputYear) => {
    ...
    const pipeline = [
        ...
        {
          $group: {
            _id: "$company.addresses.business.stateOrCountry",
    ...
    try {
        ...
        const outputFileName = `revenue-by-state-${targetYear}.json`;
